                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="POST" action="{{ route('vendor.register') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="email" required="" name="email" id="email" placeholder="Shop Email" />
                                            </div>
                                            <div class="form-group">
                                                <input type="phone" required="" name="phone" id="phone" placeholder="Phone Number" />
                                            </div>
                                            <div class="form-group">
                                                <select class="form-select mb-3 custom-select-vendor" name="vendor_join" aria-label="Default select example">
                                            ...
                                            <x-input-error :messages="$errors->get('password')" class="mt-1 mb-2" style="color: red;" />
