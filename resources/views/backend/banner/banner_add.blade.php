                            ...
                            <form id="myForm" method="post" action="{{ route('store.banner') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary" style="">
                                        <img id="showImage" src="{{ url('upload/no_image.jpg') }}" alt="slider" style="width: 768px; height: 450px; object-fit: contain; border: 0.5px solid lightgray;">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3"></div>
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-primary px-4" value="Create Banner" />
                                    </div>
                                </div>
                            </form>
                        </div>
