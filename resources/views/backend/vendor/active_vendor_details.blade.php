                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('inactive.vendor.approve') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <select class="form-select mb-3" name="vendor_join" aria-label="Default select example">
                                            ...
                                            <option value="2021" {{ $activeVendorDetails->vendor_join  == '2021' ? 'selected' : '' }}>2021</option>
                                            ...
                                            <option value="2026" {{ $activeVendorDetails->vendor_join  == '2027' ? 'selected' : '' }}>2027</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ (!empty($activeVendorDetails->photo)) ? url('upload/vendor_images/'.$activeVendorDetails->photo) : url('upload/no_image.jpg') }}" alt="Admin" style="width: 150px; height: 150px; object-fit: contain;">
                                    </div>
                                </div>
                                <div class="row">
