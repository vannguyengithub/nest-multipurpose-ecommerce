                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="myForm" method="post" action="{{ route('update.category') }}" enctype="multipart/form-data">
                                ...
                                <input class="form-control" type="hidden" name="old_image" value="{{ $category->category_image }}" />
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Category Name</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary form-group">
                                        <input type="text" name="category_name" class="form-control" placeholder="Enter Brand Name..." value="{{ $category->category_name }}" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ asset($category->category_image) }}" alt="Category" style="width: 100px; height: 100px;">
                                    </div>
                                </div>
                                <div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#myForm').validate({
            ...
            messages: {
                category_name: {
                    required: 'Please Enter Category Name', // Sửa messeages thành messages
                },
            },
            errorElement: 'span',
