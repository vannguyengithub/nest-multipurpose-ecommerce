                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="myForm" method="post" action="{{ route('update.brand') }}" enctype="multipart/form-data">
                                ...
                                <input class="form-control" type="hidden" name="old_image" value="{{ $brand->brand_image }}" />
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Brand Name</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary form-group">
                                        <input type="text" name="brand_name" class="form-control" placeholder="Enter Brand Name..." value="{{ $brand->brand_name }}" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ asset($brand->brand_image) }}" alt="Brand" style="width: 100px; height: 100px;">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3"></div>
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-primary px-4" value="Create Brand" />
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#myForm').validate({
            ...
            messages: {
                brand_name: {
                    required: 'Please Enter Brand Name', // Sửa messeages thành messages
                },
            },
            errorElement: 'span',
