...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Vendor Add Product </div>
        <div class="ps-3">
                            ...
                            <div class="border border-3 p-4 rounded">
                                <div class="row g-3">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="selling_price" class="form-control" id="price-format" placeholder="00.00">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputCompareatprice" class="form-label">Discount Price</label>
                                        <input type="text" name="discount_price" class="form-control" id="discount-format" placeholder="00.00">
                                    </div>
                                    <div class="form-group col-md-6">
...
<script  type="text/javascript">
    $(document).ready(function() {
        ...
        $('#price-format, #discount-format').on('input', function() {
