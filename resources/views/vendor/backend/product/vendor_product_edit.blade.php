                            ...
                            <div class="border border-3 p-4 rounded">
                                <div class="row g-3">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="selling_price" class="form-control" id="price-product-format" placeholder="00.00" value="{{ $products->selling_price }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputCompareatprice" class="form-label">Discount Price</label>
                                        <input type="text" name="discount_price" class="form-control" id="discount-price-format" placeholder="00.00" value="{{ $products->discount_price }}">
                                    </div>
                                    <div class="form-group col-md-6">
